...
const DeliveryApproachInteractive = () => {
  ...
  return (
      <div className="w-full bg-white p-4 sm:p-8 font-sans">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-2xl sm:text-3xl mb-6 sm:mb-8 text-gray-800 font-normal">Phased Delivery and Scale</h2>

          {/* Timeline Navigation - Mobile View */}
              ...
              {phases.map((phase) => {
                ...
                return (
                    <button
                        ...
                        className={`w-full rounded-lg text-left p-3 transition-all duration-300 
                    ${isActive
          ...
          {/* Timeline Navigation - Desktop View */}
          ...
          {/* Phase Content */}
          {currentPhase && (
              <div className={`border-l-4 ${currentPhase.borderColor} bg-gray-50 rounded-r-lg shadow-md mb-8 sm:mb-12 transition-all duration-300 overflow-hidden`}>
                <div className="p-4 sm:p-6">
                  <div className="mb-6">
                    <h3 className={`text-xl sm:text-2xl font-bold ${currentPhase.textColor} mb-3`}>{currentPhase.name}</h3>
